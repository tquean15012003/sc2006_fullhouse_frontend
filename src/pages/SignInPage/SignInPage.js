        ...
        <nav className='bg-transparent border-gray-200 px-4 lg:px-6 py-2.5 '>
          <div className='flex flex-wrap justify-between items-center mx-auto max-w-screen-xl'>
            ...
            <div className='flex items-center lg:order-2'>
              <a
                href='#'
                className='text-white focus:ring-4 font-medium rounded-lg text-md lg:text-xl px-4 lg:px-5 py-2 lg:py-2.5 mr-2 hover:bg-gray-700 focus:outline-none focus:ring-gray-800'
              >
                SIGN IN
              </a>
              <a
                href='#'
                className='focus:ring-4 font-medium rounded-lg text-md lg:text-xl px-4 lg:px-5 py-2 lg:py-2.5 mr-2 hover:bg-gray-700 focus:outline-none focus:ring-gray-800'
                style={{ color: '#FA0F0F' }}
              >
                SIGN UP
              </a>
      ...
      <div className='w-screen h-screen text-white flex justify-center items-center'>
        ...
        >
          <form>
            ...
            <p className='cursor-pointer text-right text-base md:text-xl text-orange-400'>
              Forget password?
            </p>
