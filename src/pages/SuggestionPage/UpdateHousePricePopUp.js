...
import { updateHousePriceAction } from "../../redux/actions/RetirementInfoActions";

export default function UpdateHousePricePopUp() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(updateHousePriceAction(values, setShowModal))
    }
  })
            ...
            <div className="w-1/2 my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg  flex flex-col w-full bg-neutral-700 outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                  <h3 className="text-xl md:text-3xl font-semibold">Update House Price</h3>
                  <button
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.preventDefault()
                      dispatch(updateHousePriceAction(formik.values.housePrice, setShowModal))
                    }}
                  >
                    Save Changes
                  </button>
